...
type 'ty fullt =
  | Bool   of bool
  | Var    of 'ty Id.t
  | Or     of 'ty fullt * 'ty fullt
  | And    of 'ty fullt * 'ty fullt
  | Abs    of 'ty arg Id.t * 'ty fullt
  | Forall of 'ty arg Id.t * 'ty fullt
  | Exists of 'ty arg Id.t * 'ty fullt
  | App    of 'ty fullt * 'ty fullt
  | Arith  of Arith.t
