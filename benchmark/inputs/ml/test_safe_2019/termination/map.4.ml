let rec map (x_DO_NOT_CARE_174:bool) (x_DO_NOT_CARE_175:int)
  ...
  if prev_set_flag_map_133
  then
    if s_prev_map_xs_132 > xs && xs >= 0 then () else assert false;
  map_without_checking_169
    x_DO_NOT_CARE_174 x_DO_NOT_CARE_175 x_DO_NOT_CARE_176
    f_EXPARAM_121 x_DO_NOT_CARE_171 x_DO_NOT_CARE_172
    x_DO_NOT_CARE_173 f prev_set_flag_map_133
    s_prev_map_f_EXPARAM_130 s_prev_map_xs_132 xs
and map_without_checking_169 (_:bool) (_:int) (_:int)
                            (f_EXPARAM_121:int) (_:bool) (_:int)
                            (_:int)
...
let compose (_:bool) (_:int) (_:int) (_:int) (_:bool) (_:int) (_:int)
           ...
           (set_flag_map_134:bool) (s_map_f_EXPARAM_127:int)
           (s_map_xs_129:int) (x:int) : int =
  f
    set_flag_map_134 s_map_f_EXPARAM_127 s_map_xs_129
    (g set_flag_map_134 s_map_f_EXPARAM_127 s_map_xs_129 x)
let add (_:bool) (_:int) (_:int) (x:int) (_:bool) (_:int) (_:int)
       (y:int) : int = x + y
let main (set_flag_map_134:bool) (s_map_f_EXPARAM_127:int)
  ...
  then
    ...
    0
let u_10608 : int = main false 0 0 ()
