...
and down (prev_set_flag_down_124:bool) (s_prev_down_x_123:int) (x:int) : 
  unit =
  if prev_set_flag_down_124 then assert false;
  down_without_checking_145 prev_set_flag_down_124 s_prev_down_x_123 x
...
let main (set_flag_down_125:bool) (s_down_x_122:int) (():unit) : unit =
