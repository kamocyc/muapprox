let rec app (x_DO_NOT_CARE_172:bool) (x_DO_NOT_CARE_173:int)
  ...
  then
    if s_prev_app_v_127 > v && v >= 0 then () else assert false;
  app_without_checking_158
    x_DO_NOT_CARE_172 x_DO_NOT_CARE_173 x_DO_NOT_CARE_174
    x_DO_NOT_CARE_175 i x_DO_NOT_CARE_168 x_DO_NOT_CARE_169
    x_DO_NOT_CARE_170 x_DO_NOT_CARE_171 h_EXPARAM_112
    x_DO_NOT_CARE_164 x_DO_NOT_CARE_165 x_DO_NOT_CARE_166
    x_DO_NOT_CARE_167 h x_DO_NOT_CARE_160 x_DO_NOT_CARE_161
    x_DO_NOT_CARE_162 x_DO_NOT_CARE_163 v prev_set_flag_app_129
    s_prev_app_i_124 s_prev_app_h_EXPARAM_125 s_prev_app_v_127 u
and app_without_checking_158 (_:bool) (_:int) (_:int) (_:int) (i:int)
                            (_:bool) (_:int) (_:int) (_:int)
                            (h_EXPARAM_112:int) (_:bool) (_:int)
                            (_:int) (_:int)
                            (h:(bool ->
                                  int ->
                                    int ->
  ...
  then
    app_without_checking_158
      ...
      (i - 1) set_flag_app_130 s_app_i_119 s_app_h_EXPARAM_120
      s_app_v_122 (0 * v + (0 * h_EXPARAM_112 + (0 * i + 0)))
      set_flag_app_130 s_app_i_119 s_app_h_EXPARAM_120 s_app_v_122 h
...
let rec f (set_flag_app_130:bool) (s_app_i_119:int)
         (s_app_h_EXPARAM_120:int) (s_app_v_122:int) (x:int) : (bool ->
                                                                  int ->
                                                                    int ->
                                                                    int ->
                                                                    unit ->
  ...
  then
    ...
    g
let main (set_flag_app_130:bool) (s_app_i_119:int)
        (s_app_h_EXPARAM_120:int) (s_app_v_122:int) (():unit) : unit =
  f
    set_flag_app_130 s_app_i_119 s_app_h_EXPARAM_120 s_app_v_122
    (Random.int 0) set_flag_app_130 s_app_i_119 s_app_h_EXPARAM_120
    s_app_v_122 ()
let u_8187 : unit = main false 0 0 0 ()
