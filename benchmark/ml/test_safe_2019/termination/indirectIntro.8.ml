...
and f_without_checking_252 (_:bool) (_:int) (x:int) : (bool ->
  ...
  then
    app
      ...
      (0 * x + 0) set_flag_f_244 s_f_x_241 f_without_checking_252
      set_flag_f_244 s_f_x_241 (x - 1)
  else
    g
let main (set_flag_f_244:bool) (s_f_x_241:int) (():unit) : unit =
  f set_flag_f_244 s_f_x_241 (Random.int 0) set_flag_f_244 s_f_x_241 ()
let u_45767 : unit = main false 0 ()
