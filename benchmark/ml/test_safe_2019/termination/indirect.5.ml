...
and f_without_checking_190 (_:bool) (_:int) (x:int) : (bool ->
  ...
  then
    app
      set_flag_f_182 s_f_x_179 (0 * x + 0) set_flag_f_182 s_f_x_179 f
      set_flag_f_182 s_f_x_179 (x - 1)
  else
    id
let main (set_flag_f_182:bool) (s_f_x_179:int) (():unit) : unit =
  f_without_checking_190
    set_flag_f_182 s_f_x_179 (Random.int 0) set_flag_f_182 s_f_x_179 ()
let u_10267 : unit = main false 0 ()
