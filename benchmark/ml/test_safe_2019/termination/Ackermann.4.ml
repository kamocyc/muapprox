let rec ack (x_DO_NOT_CARE_95:bool) (x_DO_NOT_CARE_96:int)
  ...
  then
    if s_prev_ack_n_79 > n && n >= 0 then () else assert false;
  ack_without_checking_93
    x_DO_NOT_CARE_95 x_DO_NOT_CARE_96 x_DO_NOT_CARE_97 m
    prev_set_flag_ack_80 s_prev_ack_m_78 s_prev_ack_n_79 n
  ...
  then
    ...
    then
      ...
      ack_without_checking_93
        ...
        (ack
          set_flag_ack_81 s_ack_m_76 s_ack_n_77 m set_flag_ack_81
          s_ack_m_76 s_ack_n_77 (n - 1))
let main (set_flag_ack_81:bool) (s_ack_m_76:int) (s_ack_n_77:int)
        (():unit) : int =
  ...
  then
    ack_without_checking_93
      set_flag_ack_81 s_ack_m_76 s_ack_n_77 m set_flag_ack_81
      s_ack_m_76 s_ack_n_77 n
  else
    0
let u_4886 : int = main false 0 0 ()
