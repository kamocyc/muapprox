...
let rec toChurch (x_DO_NOT_CARE_373:bool) (x_DO_NOT_CARE_374:int)
  ...
  toChurch_without_checking_368
    ...
    x_DO_NOT_CARE_370 x_DO_NOT_CARE_371 x_DO_NOT_CARE_372 f_EXPARAM_114
    prev_set_flag_toChurch_353 s_prev_toChurch_n_350
...
and toChurch_without_checking_368 (_:bool) (_:int) (_:int) (n:int)
  ...
  then
    ...
    compose
      ...
      s_toChurch_n_347 s_toChurch_f_EXPARAM_348 f set_flag_toChurch_354
      s_toChurch_n_347 s_toChurch_f_EXPARAM_348
      (0 * f_EXPARAM_114 + (0 * n + 0)) set_flag_toChurch_354
      s_toChurch_n_347 s_toChurch_f_EXPARAM_348
      (toChurch_without_checking_368
        set_flag_toChurch_354 s_toChurch_n_347 s_toChurch_f_EXPARAM_348
        (n - 1) set_flag_toChurch_354 s_toChurch_n_347
        s_toChurch_f_EXPARAM_348 (0 * f_EXPARAM_114 + (0 * n + 0))
        set_flag_toChurch_354 s_toChurch_n_347 s_toChurch_f_EXPARAM_348 
        f)
   ...
   then
     let tos : (bool -> int -> int -> int -> int) =
       toChurch
         ...
         s_toChurch_f_EXPARAM_348 0 set_flag_toChurch_354
